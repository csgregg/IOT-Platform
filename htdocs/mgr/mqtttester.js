...
function MQTTConnect() {
    ...
    host = secrets.getSecret("broker_host");
    port = parseInt(secrets.getSecret("broker_port"));
    user_name = secrets.getSecret("broker_user");;
    password = secrets.getSecret("broker_pwd");;
